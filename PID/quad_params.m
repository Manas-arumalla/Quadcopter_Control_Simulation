function params = quad_params()
    ...
    % Controller gains
    params.Kp_pos = diag([3.8, 3.8, 7.5]);
    params.Kd_pos = diag([2.8, 2.8, 4.2]);
    params.Ki_pos = diag([0.06, 0.06, 0.12]);

    params.Kp_att = diag([75, 75, 38]);
    ...
    params.att_rate_max = deg2rad([140; 140; 100]);  % [phi; theta; yaw] (rad/s)
